-- Seed data for Faith-Link platform
...
('Young Adults Ministry', 'A community for young adults (18-30) navigating faith, career, and relationships', 'age_group', 3, 234),
('Bible Study Circle', 'Weekly Bible studies and deep scriptural discussions', 'study', 4, 89),
('Prayer Warriors', 'Dedicated to intercession and supporting each other through prayer', 'prayer', 2, 156),
('New Believers', 'Support and guidance for those new to the Christian faith', 'support', 1, 67),
('Worship & Music', 'For those passionate about worship music and leading others in praise', 'ministry', 5, 123);
...
This verse has been my anchor during challenging times. God''s plans are always perfect! 🙏', 'verse', 24, 8),

(2, 'Please pray for my family as we navigate a difficult season. We trust in God''s timing and plan, but would appreciate your prayers for strength and guidance.', 'prayer', 42, 15),

(3, 'Attended an amazing worship service today! The message about God''s grace really touched my heart. How has God''s grace impacted your life recently? ✨', 'discussion', 18, 6),
...
Starting a new job next week and this verse is giving me so much peace!', 'verse', 31, 12),

(5, 'Grateful for this community! As a busy mom, it''s wonderful to connect with other believers who understand the joys and challenges of raising children in faith. Thank you all for your support! 💕', 'discussion', 27, 9),

(1, 'Join us for our weekly Bible study this Thursday at 7 PM! We''re diving into the book of Philippians and exploring Paul''s message of joy in all circumstances. All are welcome!', 'discussion', 15, 4),

(3, 'Struggling with anxiety lately and would love your prayers. Trying to remember Philippians 4:6-7 about not being anxious but presenting everything to God in prayer.', 'prayer', 38, 18);
